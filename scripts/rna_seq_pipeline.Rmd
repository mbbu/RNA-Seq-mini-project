...
do
	...
	trimmomatic PE $R1 $R2 $R1_paired $R1_unpaired $R2_paired $R2_unpaired -summary summary.txt -trimlog logfile SLIDINGWINDOW:4:20 MINLEN:20 ILLUMINACLIP:NexteraPE-PE.fa:2:40:15 
done
```
